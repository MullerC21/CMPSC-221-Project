...
public class AdminUserDatabase extends JFrame
{
   ...
   private void browseButtonActionPerformed( ActionEvent evt )
   {
      try
      {
         ...
         if ( numberOfEntries != 0 )
         {
            ...
            lastNameTextField.setText( currentEntry.getLastName() );
            passwordTextField.setText( currentEntry.getPassword() );
            cardTextField.setText(currentEntry.getCreditCard() );
            maxTextField.setText( "" + numberOfEntries );
            indexTextField.setText( "" + ( currentEntryIndex + 1 ) );
            nextButton.setEnabled( true );
            previousButton.setEnabled( true );
   ...
   {
      int result = personQueries.addUser( emailTextField.getText(),
         firstNameTextField.getText(), lastNameTextField.getText(),
         passwordTextField.getText(), cardTextField.getText() );
   ...
   {
      int result = personQueries.deleteUser( emailTextField.getText() );
